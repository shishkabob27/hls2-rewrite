...
[Title( "Scripted Sequence" ), Category( "Choreo" ), Icon( "theater_comedy" )]
public partial class ScriptedSequence : Entity
{
	...
	public ScriptedSequence NextScriptEnt;
	...
	public void EndSequence()
	{
		...
		{
			NextScriptEnt = FindByName( NextScript ) as ScriptedSequence;
