...
public class InventoryBar : Panel
{
	...
	public void ProcessClientInput()
	{
		...
		if ( IsOpen != wantOpen )
		{
			SelectedWeapon = localPlayer?.Inventory.ActiveChild as Weapon;
		...
		{
			localPlayer.Inventory.ActiveChildInput = SelectedWeapon;
			localPlayer.Inventory.ActiveChild = SelectedWeapon;
			IsOpen = false;
			CurrentSound.Stop();
